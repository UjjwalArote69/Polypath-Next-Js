  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans selection:bg-zinc-200">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link
          href="/"
          className="text-xl font-semibold tracking-widest text-zinc-900 uppercase inline-block mb-6"
        >
          Polypath
        </Link>
        ...
        <p className="mt-2 text-sm text-zinc-500">
          ...
          <Link
            href="/signin"
            className="font-medium text-zinc-900 hover:text-zinc-700 underline decoration-zinc-300 underline-offset-4 transition-colors"
          >
