...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\ujjwa\\OneDrive\\Desktop\\Ujjwal\\New Tech\\polypath\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\ujjwa\\OneDrive\\Desktop\\Ujjwal\\New Tech\\polypath\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../prisma",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id             String    @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name           String?\n  email          String?   @unique\n  emailVerified  DateTime?\n  image          String?\n  hashedPassword String? // Added for custom Credentials login\n  createdAt      DateTime  @default(now())\n  updatedAt      DateTime  @updatedAt\n\n  accounts Account[]\n}\n\nmodel Account {\n  id                String  @id @default(auto()) @map(\"_id\") @db.ObjectId\n  userId            String  @db.ObjectId\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.String\n  access_token      String? @db.String\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.String\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n",
  "inlineSchemaHash": "28c897dc94371748d4a32ee71f0c0433d810cbcff25f5e23f9016b00a66c93cb",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
